...
namespace Microsoft.ProjectOxford.Face
{
    ...
    public interface IFaceServiceClient
    {
        ...
        Task<Face[]> DetectAsync(string url, bool analyzesFaceLandmarks = false, bool analyzesAge = false, bool analyzesGender = false, bool analyzesHeadPose = false);
        ...
        /// <param name="analyzesHeadPose">if set to <c>true</c> [analyzes head pose].</param>
        /// <returns>The detected faces.</returns>
        Task<Face[]> DetectAsync(Stream imageStream, bool analyzesFaceLandmarks = false, bool analyzesAge = false, bool analyzesGender = false, bool analyzesHeadPose = false);
        ...
        /// The similar faces.
        /// </returns>
        Task<SimilarFace[]> FindSimilarAsync(Guid faceId, string faceGroupId, int maxNumOfCandidatesReturned = 20);
        ...
        /// <returns>Task object.</returns>
        Task CreateFaceGroupAsync(string faceGroupId, string name, string userData, FaceMetadata[] faces);

        /// <summary>
        /// Gets the face group asynchronous.
        /// </summary>
        /// <param name="faceGroupId">The face group identifier.</param>
        /// <returns>Face group object.</returns>
        Task<FaceGroup> GetFaceGroupAsync(string faceGroupId);

        /// <summary>
        /// Lists the face groups asynchronous.
        /// </summary>
        /// <returns>Face group metadata objects.</returns>
        Task<FaceGroupMetadata[]> ListFaceGroupsAsync();
        ...
        /// <param name="userData">The user data.</param>
        /// <returns>Task object.</returns>
        Task UpdateFaceGroupAsync(string faceGroupId, string name, string userData);
        ...
        /// <param name="faceGroupId">The face group identifier.</param>
        /// <returns>Task object.</returns>
        Task DeleteFaceGroupAsync(string faceGroupId);
        ...
        /// <param name="faces">The faces.</param>
        /// <returns>Task object.</returns>
        Task AddFacesToFaceGroupAsync(string faceGroupId, FaceMetadata[] faces);
        ...
        /// <param name="faceIds">The face identifiers.</param>
        /// <returns>Task object.</returns>
        Task DeleteFacesFromFaceGroupAsync(string faceGroupId, Guid[] faceIds);
    }
}