...
namespace Microsoft.ProjectOxford.Text
{
    ...
    public class TextServiceClient : ITextServiceClient
    {
        ...
        /// The Service Host
        /// </summary>
        private const string serviceHost = "https://api.projectoxford.ai/text/v1/";
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="TextServiceClient"/> class.
        /// </summary>
        /// <param name="subscriptionKey">The subscription Key.</param>
        public TextServiceClient(string subscriptionKey)
        {
        ...
        public async Task<SpellCheckResult> GetSuggestionsAsync(string text, string preContextText = null, string postContextText = null)
        {
            ...
            var response = httpClient.PostAsync("SpellChecks", content).Result;
        ...
        {
            if (response.SpellingErrors.Length > 0)
            {
